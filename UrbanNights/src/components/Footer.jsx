        ...
        <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                        urbanNights is your trusted partner for unforgettable travel experiences. We offer a curated selection of luxurious accommodations, ensuring you find the perfect place to stay. Our commitment to quality and service sets us apart, making your journey seamless and memorable. Explore the world with UrbanNights and indulge in the finest hospitality.
                    </p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} UrbanNights. All rights reserved. <span class="text-red-500">❤️</span>
                    developed by Anit Baranwal</p>
